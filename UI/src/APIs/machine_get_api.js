...
export const updateDrifts = async (machineId, DriftName, affected_drift, formData) => {
  try {
    ...
    {
      affected_element: affected_drift === "" ? "-1" : affected_drift,
      updated_data: updated_data
    });
    return response.data;
  } catch (error) {
...
export const updateMarkers = async (machineId, MarkerName, affected_marker, formData) => {
  try {
    ...
    {
      affected_element: affected_marker === "" ? "-1" : affected_marker,
      updated_data: updated_data
    });
    return response.data;
  } catch (error) {
...
export const updateMonitors = async (machineId, MonitorName, affected_monitor, formData) => {
  try {
    ...
    {
      affected_element: affected_monitor === "" ? "-1" : affected_monitor,
      updated_data: updated_data
    });
    return response.data;
  } catch (error) {
...
export const fetchMachineSunBurstData = async (id) => {
  try {
    const response = await axios.get(`/machine/machine/${id}/sunburst/`);
...
export const fetchMachineSunBurstParentChildren = async (id, section, elementType) => {
  try {
    const response = await axios.get(`/machine/machine/${id}/sunburst_children?section=${section}&element_type=${elementType}`);
      return response.data;
