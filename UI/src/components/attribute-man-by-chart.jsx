...
const AttributeManByChart = () => {
  ...
  const callParentTable = async (section, type, element) => {
    ...
    console.log("catching the data from sub chart from child in the parent",section, type, element)
    ...
    await fetchQuadrupoles_func(selectedMachine, section).then( (fetchedQuadrupoles )=>{

      const quadDetails = fetchedQuadrupoles.find((quad) => quad.name === element);
        ...
        <Col md={6}>
          <Row>
            ...
            <Col md={12}>
              ...
              {/* not used */}
              <Form.Group controlId="groupSelect" style={{ display: 'none' }}>
              ...
              <Form.Group controlId="quadSelect" style={{ display: 'none' }}>
...
export default AttributeManByChart;
