...
def bessy2Lattice() -> at.Lattice:
    ...
    D1_secondhalf = [ \
        ...
        at.Dipole('BM2D1R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T1 = [ \
        ...
        at.Dipole('BM1T1R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T1R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D2 = [ \
        ...
        at.Dipole('BM1D2R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D2R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T2 = [ \
        ...
        at.Dipole('BM1T2R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T2R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D3 = [ \
        ...
        at.Dipole('BM1D3R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D3R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T3 = [ \
        ...
        at.Dipole('BM1T3R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T3R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D4 = [ \
        ...
        at.Dipole('BM1D4R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D4R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T4 = [ \
        ...
        at.Dipole('BM1T4R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T4R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D5 = [ \
        ...
        at.Dipole('BM1D5R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D5R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T5 = [ \
        ...
        at.Dipole('BM1T5R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T5R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D6 = [ \
        ...
        at.Dipole('BM1D6R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D6R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T6 = [ \
        ...
        at.Dipole('BM1T6R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T6R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D7 = [ \
        ...
        at.Dipole('BM1D7R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D7R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T7 = [ \
        ...
        at.Dipole('BM1T7R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T7R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D8 = [ \
        ...
        at.Dipole('BM1D8R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2D8R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    T8 = [ \
        ...
        at.Dipole('BM1T8R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
        ...
        at.Dipole('BM2T8R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
    ...
    D1_firsthalf = [ \
        ...
        at.Dipole('BM1D1R', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint, Corrector='H', KickAngle=[0, 0]), \
