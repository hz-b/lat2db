...
def bessy2Lattice() -> at.Lattice:
    ...
    BM2D5R1_slicing = np.array(
        [0.278008, 0.025992, 0.009804, 0.01292, 0.100776, 0.0817, 0.1938, 0.152]) / bending_length
    ...
    D1_secondhalf = [ \
        ...
        at.Dipole('BM2D1R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T1 = [ \
        ...
        at.Dipole('BM1T1R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T1R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D2 = [ \
        ...
        at.Dipole('BM1D2R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D2R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2D2R1_slicing), \
    ...
    T2 = [ \
        ...
        at.Dipole('BM1T2R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T2R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D3 = [ \
        ...
        at.Dipole('BM1D3R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D3R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T3 = [ \
        ...
        at.Dipole('BM1T3R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T3R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D4 = [ \
        ...
        at.Dipole('BM1D4R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D4R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T4 = [ \
        ...
        at.Dipole('BM1T4R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T4R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D5 = [ \
        ...
        at.Dipole('BM1D5R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D5R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2D5R1_slicing), \
    ...
    T5 = [ \
        ...
        at.Dipole('BM1T5R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T5R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D6 = [ \
        ...
        at.Dipole('BM1D6R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D6R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T6 = [ \
        ...
        at.Dipole('BM1T6R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T6R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D7 = [ \
        ...
        at.Dipole('BM1D7R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D7R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T7 = [ \
        ...
        at.Dipole('BM1T7R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T7R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D8 = [ \
        ...
        at.Dipole('BM1D8R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2D8R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    T8 = [ \
        ...
        at.Dipole('BM1T8R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
        ...
        at.Dipole('BM2T8R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM2_slicing), \
    ...
    D1_firsthalf = [ \
        ...
        at.Dipole('BM1D1R1', bending_length, bending_angle, EntranceAngle=bending_entrance_angle,
                  ExitAngle=bending_exit_angle, FullGap=bending_fullgap, FringeInt1=bending_entrance_fint,
                  FringeInt2=bending_exit_fint).divide(BM1_slicing), \
...
def export_to_mongodb(lattice, mongodb_uri, database_name, collection_name):
